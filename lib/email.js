...
export async function sendEmail({ to, subject, html, text }) {
  ...
  // Fire-and-forget — don't await pollUntilDone() which can block 10-30s
  // and exceed serverless function timeouts. Azure queues delivery immediately.
  client.beginSend({
    ...
    // Swallow send errors — email failure is non-fatal
  });
